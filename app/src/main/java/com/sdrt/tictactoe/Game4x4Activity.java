...
public class Game4x4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Tic Tac Toe 4x4"); // Set the app title on the top of the app bar
        ...
        // Initialize the buttons in the 4x4 grid
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                String buttonID = "button" + ((i * 4) + (j + 1));
